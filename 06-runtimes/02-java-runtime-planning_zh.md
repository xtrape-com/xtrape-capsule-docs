...
The current CE（社区版） implementation focus is **Node.js**. Java Runtime planning exists to keep the Capsule governance
model compatible with enterprise Java and Spring-based services in future EE（企业版） or later CE（社区版） versions.
