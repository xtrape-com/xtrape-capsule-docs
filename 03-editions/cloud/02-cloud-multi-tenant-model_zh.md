...
Opstage（运维舞台） Cloud（云版） is the future hosted SaaS edition of the `xtrape-capsule` product family. Multi-tenancy is a
Cloud（云版） requirement, not a CE（社区版） v0.1 implementation requirement.
