...
Opstage（运维舞台） EE（企业版） is the future private commercial edition of the `xtrape-capsule` product family. Enterprise security capabilities are not CE（社区版） v0.1 implementation requirements.
