...
================================================================================
原始文件 / Original File: 11-ce-open-source-strategy.md
...
> **Precedence rule**: When this document and `08-decisions/` ADRs or `09-contracts/` disagree, the ADRs and contracts win for CE（社区版） v0.1.
...
CE（社区版） should be useful without requiring EE（企业版） or Cloud（云版）.

---

## 3. Why CE（社区版） Should Be Open Source

CE（社区版） should be open source because the product sits close to sensitive runtime governance data.
...
Open source also helps establish the Capsule Service（胶囊服务） concept before the commercial product is mature.

---

## 4. What CE（社区版） Should Prove

CE（社区版） should prove the minimum complete Capsule governance loop:
...
If this loop is useful, EE（企业版） and Cloud（云版） can grow naturally from it.

---

## 5. Open Source Product Principles

CE（社区版） should follow these product principles:

1. CE（社区版） must be genuinely useful.
2. CE（社区版） should be easy to run.
3. CE（社区版） should be safe by default.
4. CE（社区版） should not require external SaaS.
5. CE（社区版） should not hide critical source code.
6. CE（社区版） should not feel like a broken trial version.
7. CE（社区版） should reserve commercial extension points cleanly.
8. CE（社区版） should document what is free, what is future, and what is commercial.
9. CE（社区版） should build trust before monetization pressure.
10. CE（社区版） should prioritize developer adoption and real usage feedback.
...
Inside `xtrape-capsule-ce` (the CE（社区版） monorepo), pnpm workspace packages are arranged as follows:
...
### 7.2 Recommended CE（社区版） license

Recommended license for CE（社区版）:
...
For this project, broad adoption and trust are more important in the CE（社区版） phase.

### 7.5 Commercial editions

EE（企业版） and Cloud（云版） can remain commercial while CE（社区版） is Apache-2.0.

The key is to keep CE（社区版） useful and define commercial features clearly.

---

## 8. CE（社区版） / EE（企业版） / Cloud（云版） Boundary

The open-source strategy must clearly define edition boundaries.

### 8.1 CE（社区版） should include
...
- Java/Python Agent（代理） SDKs;
- sidecar/external Agents;
- enterprise support.

### 8.3 Cloud（云版） may include
...
The boundary should be based on scale, enterprise governance, and managed service value, not on disabling the core CE（社区版） loop.
...
CE（社区版） should contain the product kernel.

EE（企业版） and Cloud（云版） should add advanced operational, organizational, and enterprise capabilities.

### 9.1 What should remain open

The following should remain open in CE（社区版）:

- core Backend;
- Web UI for CE（社区版） features;
- Node.js embedded Agent（代理） SDK;
...
1. What is Opstage（运维舞台） CE（社区版）?
2. What problem does it solve?
3. What is a Capsule Service（胶囊服务）?
4. How do I run it?
5. How do I start the demo service?
6. How do I create a registration token?
7. How do I embed the Agent（代理） SDK?
8. What is included in CE（社区版）?
9. What is planned for EE（企业版）/Cloud（云版）?
...
设计 documents may remain in a separate docs repository or be included under:
...
- bug reports;
- Agent（代理） SDK feedback;
- UI improvements;
- documentation improvements;
- demo Capsule Services;
- new action examples;
- deployment examples;
- future Agent（代理） SDK language proposals.

---

## 14. Governance Strategy

CE（社区版） repository governance can start simple.
...
- design principles;
- security model;
- compatibility with EE（企业版）/Cloud（云版） extension path;
- implementation quality;
- documentation quality.

### 14.3 Avoiding scope creep

Do not accept large enterprise features into CE（社区版） v0.1 before the core loop is stable.
...
- implemented CE（社区版） features;
- planned CE（社区版） features;
- possible EE（企业版） features;
- possible Cloud（云版） features;
- research ideas.
...
Open source CE（社区版） should support future commercialization without damaging trust.
...
Do not introduce hard commercial gates before CE（社区版） proves value.

Do not make CE（社区版） unusable just to force upgrades.
...
- hosted Cloud（云版） convenience.

---

## 18. Risks

### 18.1 Risk: CE（社区版） becomes too heavy

Mitigation:

- keep CE（社区版） v0.1 focused on the vertical slice;
- defer EE（企业版）/Cloud（云版） features;
- use SQLite and single-container deployment.

### 18.2 Risk: CE（社区版） feels too weak

Mitigation:

- include complete Agent（代理） registration, command, action, and audit loop;
- include useful UI;
...
- use brand, speed, commercial support, and Cloud（云版） service quality;
...
- document CE（社区版）/EE（企业版）/Cloud（云版） boundaries;
- explain what CE（社区版） is not;
...
Opstage（运维舞台） CE（社区版） should be open source to build trust, validate the Capsule Service（胶囊服务） model, and create an adoption base.

The most important open-source rule is:

> CE（社区版） must be a genuinely useful product, not a disabled preview of future commercial editions.
